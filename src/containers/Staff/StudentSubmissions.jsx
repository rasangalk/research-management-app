            ...
            <div className='flex items-center gap-8'>
              <div className='ml-[50.5rem]'>
                ...
                <div className='flex flex-col'>
                  <select className='h-[2.2rem] text-sm px-3 py-1 bg-white border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block lg:w-[24rem] sm:w-144 rounded-md focus:ring-1'>
