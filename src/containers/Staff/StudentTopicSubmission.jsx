...
function StudentTopicSubmission() {
  ...
  const handleEdit = () => {
    ...
    dispatch(
      evaluateStudentSubmission(
        studentSubmission.assignment.assignment[0]._id,
        data
      )
    );
  };
                ...
                <div className=" grid grid-cols-3 w-[60rem]">
                  ...
                  <div className="col-span-2 mt-8">
                    ...
                    <textarea
                      ...
                      className="resize-none font-semibold mt-1 px-3 py-1 bg-white border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block lg:w-[27rem] sm:w-144 rounded-md text-base focus:ring-1"
                    ></textarea>
                  </div>
                  <div className="mt-8">
                    <p className="capitalize text-slate-700 text-sm mb-1">
...
export default StudentTopicSubmission;
