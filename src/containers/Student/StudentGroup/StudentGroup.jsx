								...
								<div className=' grid grid-cols-2 overflow-y-auto h-[20rem]'>
									<div className='flex flex-col gap-12 '>
										...
										<div>
											...
											<select
												name='Specialization'
												className='font-Nunito font-semibold mt-1 px-3 py-1 bg-white border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block lg:w-96 sm:w-144 rounded-md focus:ring-1 mb-20'
												onChange={e => setLeaderSpecialization(e.target.value)}>
												<option
