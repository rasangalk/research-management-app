...
function FeedbackAccepted() {
	...
	const showBtn1 = () => {
		return (
			<div className=''>
				<button
					className='captalize font-bold capitalize mt-[3rem] text-lg  px-6 py-1 bg-regal-blue text-white border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block lg:w-50 sm:w-50 rounded-md hover:bg-regal-blue-active ml-[52rem] text-sm'
					onClick={() => {
	...
	const showBtn2 = () => {
		return (
			<div className=''>
				<button className='captalize font-bold capitalize mt-[3rem] text-lg  px-6 py-1 bg-regal-blue text-white border border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block lg:w-50 sm:w-50 rounded-md hover:bg-regal-blue-active ml-[52rem] text-sm'>
