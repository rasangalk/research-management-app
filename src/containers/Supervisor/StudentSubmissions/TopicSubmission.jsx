									...
									<table className='border-collapse w-full '>
										<thead>
											<tr>
												...
												<th className='py-2 px-2 uppercase bg-white text-left sticky top-0 z-100'>
													date & time
												</th>
											</tr>
										</thead>
										<tbody>
											{submission.submission
												.filter(submission => submission.isViewed === "0")
												.map(submission => (
													<tr
														...
														<td className='lowercase py-2 px-2'>
															<div className='flex flex-row gap-2 items-center'>
																...
																<p>{submission.createdAt.match(/\d\d:\d\d/)}</p>
																<img
																	src={GreenDot}
																	className='h-3 drop-shadow-sm z-10'
																/>
															</div>
														</td>
													</tr>
