...
import StaffMarkings from "./src/containers/Staff/Markings";
function App() {
	...
	return (
		<div className='App'>
			<Routes>
				...
				<Route path='/student/topic/accepted/:id' element={<PrivateWrapper />}>
					<Route
				...
				<Route
					path='/coSupervisor/assigned-topics'
					element={<PrivateWrapper />}>
					<Route
						path='/coSupervisor/assigned-topics'
						element={<CoAssignedTopics />}
					/>
				</Route>
				...
				//////////////////////////////Staff////////////////////////
				<Route path='/staff/edit-profile' element={<PrivateWrapper />}>
				...
				<Route
					path='/staff/staff-markings/:schemaId'
					element={<PrivateWrapper />}>
					<Route
						path='/staff/staff-markings/:schemaId'
						element={<StaffMarkings />}
					/>
				</Route>
			</Routes>
		</div>
