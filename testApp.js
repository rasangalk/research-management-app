...
function App() {
    ...
    <div className='App'>
      <Routes>
        ...
        //////////////////////////////Co-Supervisor////////////////////////
        <Route path='/r15' element={<CoMarkings />} />
        <Route path='/r16' element={<CoSubmissions />} />
        <Route path='/r17' element={<CoTopicSubmission />} />
        <Route path='/r18' element={<CoSupervisorProfile />} />
        <Route path='/r19' element={<CoAssignedTopicDetails />} />
        <Route path='/r20' element={<CoAssignedTopics />} />
        <Route path='/r21' element={<CoSupervisortopicsAcceptanceReject />} />
        <Route path='/r22' element={<CoTopics />} />
        //////////////////////////////Staff////////////////////////
